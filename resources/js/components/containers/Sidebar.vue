<template>
    <aside
        class="main-sidebar sidebar-dark-primary elevation-4 jewelry-sidebar"
    >
                ...
                >
                    ...
                    <template v-else>
                        ...
                        <li class="nav-section" v-if="can('dashboard')">
                            ...
                            <ul
                                class="nav nav-section__items"
                                v-show="isSectionOpen('home')"
                            >
                                <li class="nav-item">
                                    <router-link
                                        to="/dashboard"
                            ...
                            >
                                ...
                                <li class="nav-item">
                                    <router-link to="/vendor" class="nav-link">
                                        <i
                                            class="nav-icon far bi bi-person-circle"
                                        ></i>
                                        <p class="text-md">
                                            {{ $t("nav.supplier") }}
                                        </p>
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        <i
                                            class="nav-icon far bi bi-box-arrow-in-right"
                                        ></i>
                                        <p class="text-md">
                                            {{ $t("nav.purchase") }}
                                            <i
                        ...
                        >
                            ...
                            <ul
                                class="nav nav-section__items"
                                v-show="isSectionOpen('sales')"
                            >
                                <li
                                    class="nav-item"
                                    v-if="can('sales')"
                                    data-submenu="salesbill"
                                >
                                    <a
                                        href="#"
                                        class="nav-link"
                                    ...
                                    >
                                        <i
                                            class="nav-icon far bi bi-receipt"
                                        ></i>
                                        <p class="text-md">
                                            {{ $t("nav.salesBill") }}
                                            <i
                                ...
                                >
                                    ...
                                    >
                                        <i
                                            class="nav-icon far bi bi-receipt-cutoff"
                                        ></i>
                                        <p class="text-md">
                                            {{ $t("nav.invoice") }}
                                            <i
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        <i
                                            class="nav-icon far bi bi-dash-circle"
                                        ></i>
                                        <p class="text-md">
                                            {{ $t("nav.expense") }}
                                            <i
                                ...
                                <li class="nav-item" v-if="isAdmin">
                                    <router-link to="/credit" class="nav-link">
                                        <i
                                            class="nav-icon fas fa-money-bill-wave"
                                        ></i>
                                        <p class="text-md">
                                            {{ $t("nav.credit") }}
                                        </p>
                                ...
                                <li class="nav-item" v-if="isAdmin">
                                    ...
                                    >
                                        <i
                                            class="nav-icon fas fa-hand-holding-usd"
                                        ></i>
                                        <p class="text-md">
                                            {{ $t("nav.investors") }}
                                        </p>
                                ...
                                <li class="nav-item" v-if="isAdmin">
                                    <router-link
                                        to="/distributeexpenses"
                                        class="nav-link"
                                    >
                                        <i class="nav-icon fas fa-divide"></i>
                                        <p class="text-md">
                                            {{ $t("nav.distributeExpenses") }}
                                        </p>
                                    </router-link>
                                </li>
                            </ul>
                        ...
                        <li class="nav-section" v-if="isAdmin">
                            ...
                            >
                                ...
                                <li class="nav-item">
                                    ...
                                    >
                                        <i
                                            class="nav-icon fas fa-clipboard-list"
                                        ></i>
                                        <p class="text-md">
                                            {{ $t("nav.auditLogs") }}
                                        </p>
...
export default {
    ...
    mounted() {
        this.$el.addEventListener("wheel", this.onSidebarWheel, {
            passive: true,
            capture: true
        });
    ...
    beforeDestroy() {
        this.$el.removeEventListener("wheel", this.onSidebarWheel, {
            capture: true
        });
    ...
    methods: {
        ...
        isTypingTarget(target) {
            ...
            return !!target.closest(
                '.ui.dropdown, .ui.search, [contenteditable="true"]'
            );
        },
