      ...
      <div class="col-md-12 mt-3">
        ...
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title">{{ $t('inwardQuality.newTitle') }}</h3>
          ...
          <div class="card-footer">
            <button type="submit" v-on:click="addInwardQuality" class="btn btn-primary text-md">{{ $t('common.add') }}</button>
            ...
            .then((res) => {
              if (res.data.status == -1) {
                ...
                swal.fire({
                  ...
                  html: "<h5 style='color:#9C9794'>" + this.$t('inwardQuality.added') + "</h5>",
                  icon: 'success'
                }).then((result) => {
                  this.resetFields();
